...
export default function Question10() {
  ...
  const question = "What do you hope to gain from this community?";
  const options = [
    "Deep friendships and meaningful connections",
  ...
  const handleContinue = async () => {
    ...
    await AsyncStorage.setItem('question-10-answer', selectedAnswer.toString());
