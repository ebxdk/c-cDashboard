...
export default function Question5() {
  ...
  const question = "How do you prefer to spend your free time?";
  const options = [
  ...
  const handleContinue = async () => {
    ...
    await AsyncStorage.setItem('question-5-answer', selectedAnswer.toString());
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
    router.push('/bio-data-questions/question-6');
  };
