...
export default function BottomNavBar() {
  ...
  if (pathname === '/' || pathname === '/login' || pathname === '/signup' || pathname === '/verify-email' || pathname === '/setup-face-id' || pathname === '/setup-profile' || pathname.startsWith('/question-') || pathname.startsWith('/bio-data-questions/') || pathname === '/persona-selection' || pathname === '/subscription' || pathname === '/loading-screen' || pathname === '/match-results' || pathname === '/people-matches') {
    return null;
  }
